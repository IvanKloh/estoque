	...
	<div class="menu">
			<div id="banner"title="Meu Baner" onclick="inicio('<?php echo $server?>');">
		 	...
		 	<div class="menuEpi">
		 	  ...
		 	  <a href="<?php echo "http://".$server."/estoque/visao/"?>listarMov.php">
		 	  <i class="fa fa-list-ul" aria-hidden="true"></i>
		 	REGISTROS</a>
			</div>
			<div class="menuFuncionario">
			  <a href="<?php echo "http://".$server."/estoque/visao/"?>relProdutos.php"> 
			    <i class="fa fa-list-ul" aria-hidden="true"></i>
			EPIS</a>
			</div>
			<div class="menuMovimentacao">
			  <a href="<?php echo "http://".$server."/estoque/visao/"?>relFuncionario.php">
			  <i class="fa fa-list-ul" aria-hidden="true"></i>
			FUNCIÓNARIO</a>
			</div>
			
			<div class="menuUsuario">
			  <a href="<?php echo "http://".$server."/estoque/visao/"?>relUsuarios.php">
			   <i class="fa fa-list-ul" aria-hidden="true"></i>
			USUÁRIOS </a>
			</div>
			<div class="menuSair">
		...
		<div id="mostrar">
			<img onclick="hideElement();" src="<?php echo 'http://'.$server.'/estoque/css/imagem/'?>interrogacao.png"style="width: 90px; height: 90px;margin-left: 1111px; bottom: 11px; position: relative; background-color: #5c6d6c; border-radius: 11px; padding: 4px;">
